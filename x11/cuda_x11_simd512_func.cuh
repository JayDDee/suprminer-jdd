static __constant__  const uint32_t c_perm[8][8] = {
...
__device__ __forceinline__
static void STEP8_IF(const uint32_t *const __restrict__ w, const uint32_t i, const uint32_t r, const uint32_t s, uint32_t *const __restrict__ A, const uint32_t *const __restrict__ B, const uint32_t *const __restrict__ C, uint32_t *const __restrict__ D)
{
	uint32_t R[8];
...
__device__ __forceinline__
static void STEP8_MAJ(const uint32_t *const __restrict__ w, const uint32_t i, const uint32_t r, const uint32_t s, uint32_t *const __restrict__ A, const uint32_t *const __restrict__ B, const uint32_t *const __restrict__ C, uint32_t *const __restrict__ D)
{
	uint32_t R[8];
...
__device__ __forceinline__
static void Round8_0_final(uint32_t *const __restrict__  A, const uint32_t r, const  uint32_t s, const uint32_t t, const uint32_t u){
...
__device__ __forceinline__
static void Round8_1_final(uint32_t *const __restrict__  A, const uint32_t r, const  uint32_t s, const uint32_t t, const uint32_t u){
...
__device__ __forceinline__
static void Round8_2_final(uint32_t *const __restrict__  A, const uint32_t r, const  uint32_t s, const uint32_t t, const uint32_t u){
...
__device__ __forceinline__
static void Round8_3_final(uint32_t*const __restrict__  A, const uint32_t r, const  uint32_t s, const uint32_t t, const uint32_t u){
...
*/
__device__ __forceinline__
static void FFT_16(int *const __restrict__ y){
...
#endif
static void x11_simd512_gpu_expand_64(uint32_t threads, const uint32_t* __restrict__ g_hash, uint4 * __restrict__ g_temp4)
{
