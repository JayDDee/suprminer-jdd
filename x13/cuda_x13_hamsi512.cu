...
#define hamsi_load_alpha( rc, alpha ) \
{ \
...
#define ROUND_BIG_device( rc, alpha ) \
{ \
   hamsi_load_alpha( rc, alpha ); \
   SBOX_device( hamsi_s00, hamsi_s08, hamsi_s10, hamsi_s18 ); \
   SBOX_device( hamsi_s01, hamsi_s09, hamsi_s11, hamsi_s19 ); \
   SBOX_device( hamsi_s02, hamsi_s0A, hamsi_s12, hamsi_s1A ); \
   SBOX_device( hamsi_s03, hamsi_s0B, hamsi_s13, hamsi_s1B ); \
   SBOX_device( hamsi_s04, hamsi_s0C, hamsi_s14, hamsi_s1C ); \
   SBOX_device( hamsi_s05, hamsi_s0D, hamsi_s15, hamsi_s1D ); \
   SBOX_device( hamsi_s06, hamsi_s0E, hamsi_s16, hamsi_s1E ); \
   SBOX_device( hamsi_s07, hamsi_s0F, hamsi_s17, hamsi_s1F ); \
   L_device( hamsi_s00, hamsi_s09, hamsi_s12, hamsi_s1B ); \
   L_device( hamsi_s01, hamsi_s0A, hamsi_s13, hamsi_s1C ); \
   L_device( hamsi_s02, hamsi_s0B, hamsi_s14, hamsi_s1D ); \
   L_device( hamsi_s03, hamsi_s0C, hamsi_s15, hamsi_s1E ); \
   L_device( hamsi_s04, hamsi_s0D, hamsi_s16, hamsi_s1F ); \
   L_device( hamsi_s05, hamsi_s0E, hamsi_s17, hamsi_s18 ); \
   L_device( hamsi_s06, hamsi_s0F, hamsi_s10, hamsi_s19 ); \
   L_device( hamsi_s07, hamsi_s08, hamsi_s11, hamsi_s1A ); \
   L_device( hamsi_s00, hamsi_s02, hamsi_s05, hamsi_s07 ); \
   L_device( hamsi_s10, hamsi_s13, hamsi_s15, hamsi_s16 ); \
   L_device( hamsi_s09, hamsi_s0B, hamsi_s0C, hamsi_s0E ); \
   L_device( hamsi_s19, hamsi_s1A, hamsi_s1C, hamsi_s1F ); \
}

#define ROUND_BIG_host( rc, alpha ) \
{ \
   hamsi_load_alpha( rc, alpha ); \
   SBOX_host( hamsi_s00, hamsi_s08, hamsi_s10, hamsi_s18 ); \
   SBOX_host( hamsi_s01, hamsi_s09, hamsi_s11, hamsi_s19 ); \
   SBOX_host( hamsi_s02, hamsi_s0A, hamsi_s12, hamsi_s1A ); \
   SBOX_host( hamsi_s03, hamsi_s0B, hamsi_s13, hamsi_s1B ); \
   SBOX_host( hamsi_s04, hamsi_s0C, hamsi_s14, hamsi_s1C ); \
   SBOX_host( hamsi_s05, hamsi_s0D, hamsi_s15, hamsi_s1D ); \
   SBOX_host( hamsi_s06, hamsi_s0E, hamsi_s16, hamsi_s1E ); \
   SBOX_host( hamsi_s07, hamsi_s0F, hamsi_s17, hamsi_s1F ); \
   L_host( hamsi_s00, hamsi_s09, hamsi_s12, hamsi_s1B ); \
   L_host( hamsi_s01, hamsi_s0A, hamsi_s13, hamsi_s1C ); \
   L_host( hamsi_s02, hamsi_s0B, hamsi_s14, hamsi_s1D ); \
   L_host( hamsi_s03, hamsi_s0C, hamsi_s15, hamsi_s1E ); \
   L_host( hamsi_s04, hamsi_s0D, hamsi_s16, hamsi_s1F ); \
   L_host( hamsi_s05, hamsi_s0E, hamsi_s17, hamsi_s18 ); \
   L_host( hamsi_s06, hamsi_s0F, hamsi_s10, hamsi_s19 ); \
   L_host( hamsi_s07, hamsi_s08, hamsi_s11, hamsi_s1A ); \
   L_host( hamsi_s00, hamsi_s02, hamsi_s05, hamsi_s07 ); \
   L_host( hamsi_s10, hamsi_s13, hamsi_s15, hamsi_s16 ); \
   L_host( hamsi_s09, hamsi_s0B, hamsi_s0C, hamsi_s0E ); \
   L_host( hamsi_s19, hamsi_s1A, hamsi_s1C, hamsi_s1F ); \
}
...
#pragma unroll 2
			...
			for (int r = 0; r < 6; r += 2) {
				ROUND_BIG_device(r, d_alpha_n);
				ROUND_BIG_device(r + 1, d_alpha_n);
			}
			T_BIG;
		}
		...
		for (int r = 0; r < 12; r += 2) {
			ROUND_BIG_device(r, d_alpha_f);
			ROUND_BIG_device(r + 1, d_alpha_f);
		}
		T_BIG;
